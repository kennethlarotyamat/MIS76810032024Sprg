...
public class Manager extends Staff { // public class Cube extends Rectangle {
	...
	public double getStipendLevel() {
		if (stipendLevel == '1') {
			stipendLevel = stipendLevel * stipendLevelValue; // StipendLevel//System.out.print("Ticket Class 1 has been
																// added to your cart, the amount due is $15");
		} else if (stipendLevel == '2') {
			stipendLevel = stipendLevel * stipendLevelValue; // System.out.print("Ticket Class 2 has been added to your
																// cart, the amount due is $15");
		} else if (stipendLevel == '3') {
			stipendLevel = stipendLevel * stipendLevelValue; // System.out.print("Ticket Class 3 has been added to your
																// cart, the amount due is $25");
		} else if (stipendLevel == '4') {
			stipendLevel = stipendLevel * stipendLevelValue; // System.out.print("Ticket Class 4 has been added to your
																// cart, the amount due is $35");
		} else if (stipendLevel == '5') {
			stipendLevel = stipendLevel * stipendLevelValue; // System.out.print("Ticket Class 4 has been added to your
																// cart, the amount due is $35");
		} else {
			stipendLevel = stipendLevel * stipendLevelValue; // System.out.print("The ticket class entered is not a
																// valid ticket class");
		}
		return stipendLevel;
	}
